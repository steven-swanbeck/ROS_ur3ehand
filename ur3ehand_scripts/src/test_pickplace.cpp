...
void pick(moveit::planning_interface::MoveGroupInterface& move_group) {
    ...
    // orientation.setRPY(tau / 2, - tau / 4, -tau / 4);
    orientation.setRPY(tau / 2, -tau / 8, -tau/4);
    grasps[0].grasp_pose.pose.orientation = tf2::toMsg(orientation);
    // grasps[0].grasp_pose.pose.position.x = -0.22285;
    // grasps[0].grasp_pose.pose.position.y = 0.38652;
    // grasps[0].grasp_pose.pose.position.z = 0.3;//0.08775;
    grasps[0].grasp_pose.pose.position.x = 0.653;
    grasps[0].grasp_pose.pose.position.y = 0.-0.653;
    grasps[0].grasp_pose.pose.position.z = 0.248;//0.08775;
